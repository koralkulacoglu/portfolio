        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          <div>
            <p className="text-lg text-slate-300 leading-relaxed mb-6">
              ...
              with a passion for building innovative solutions that make a real
              impact. With experience at companies like BitGo, AtoB, and D2L,
              I've worked on everything from AI-powered GTM systems to
              multi-agent frameworks.
            </p>
            <p className="text-lg text-slate-300 leading-relaxed">
              My projects have generated significant value – from winning the
              Canada-Wide Science Fair to working on systems that projected $8M+
              ARR. I love tackling complex problems at the intersection of AI
